          ...
          {/* {cardItem.map(({ id, logo, name }) => {
           ...
           <div
              ...
              >
                ...
                ></img>
                <div>
                  <div className="px-2 font-bold text-xl mb-2">{"SocialMedia"}</div>
                  <p className="px-2 text-gray-700 text-sm">
                    for creating social media create your post and also delete the project this is more intrective
                  </p>
                </div>
                <div className="px-3 py-5 mt-5 space-x-3 justify-between items-center flex">
